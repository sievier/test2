...
def test(epoch,month):
    ...
    for step, (batch_data, batch_target) in enumerate(tensor_dataloader):#一个batch（64个会话）
        ...
        for itemID in CandicateItemIDList:  #一个batch下的下单ItemID
        ...
        bacth_weight_view=encoder[2]  #view-level weight
        ...
        print('batch_sample_Encoder_shape:', batch_sample_Encoder.size())
